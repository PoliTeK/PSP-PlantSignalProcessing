...
public:
    ...
    */
    ...
    /*
        * Sets touch, release threshold values to specific channel.
            * @param touch Threshold touch value.
            * @param release Threshold release value.
            * @param channel Channel of thresholds.
    */

    void setThreshold (uint8_t touch, uint8_t release, uint8_t channel);
